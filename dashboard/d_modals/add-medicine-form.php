<!-- Add Medicines -->
<form action="d_modals/add-med.php" method="POST" id="add-new-med-form" >
            ...
            <div class="modal-content px-3 pt-3 mb-0">
                ...
                <div class="modal-body p-0 mt-4">
                    <div class="errors">
                        ...
                        <span class="display-none error-add-new-med">Something went wrong, please try later!</span>
                    </div>
                    ...
                    <div id="step-1" class="form-active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                ...
                                <select name="unit" id="unit-dropdown" class="custom-select">
                ...
                <div class="form-hidden add-med-footer">
                    <div class="modal-footer px-0">
                        ...
                        <input type="submit" class="button rounded ls0 font-weight-medium m-0 d-sm-flex" name="add-new-med" value="Add Medicine" id="add-medicines">
                        </div>
                    </div>
                </div>
            </div>
